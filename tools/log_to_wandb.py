...
if __name__ == "__main__":
    ...
    # CTP various configs
    cfg_path = "/var/scratch/pbagad/projects/epic-kitchens-ssl/configs/EPIC-KITCHENS/CTP/32x112x112_CTP_R2+1D-18_K400_LR0.025.yaml"
    log_path = "/var/scratch/pbagad/expts/epic-kitchens-ssl/32x112x112_CTP_R2+1D-18_K400_LR0.025/logs/train_logs.txt"
